...
/*** https://tema2.dokuzyazilim.com/js/fancybox/jquery.fancybox.pack.js?v=2783 ***/
...
/*** https://tema2.dokuzyazilim.com/templates/default-neo/js/js.js?v=2783 ***/
...
/*** https://tema2.dokuzyazilim.com/templates/neo-gold/js/main.js?v=2783 ***/
$(function() {
	function changeQuantity(value) {
        var quantity = Number($(".form-group-quantity .prd-quantity").val());
        if (quantity === 1 && value === -1) quantity = 2;
        $(".form-group-quantity span").text(quantity + value);
        $(".form-group-quantity .prd-quantity").val(quantity + value);
    }

    $(".form-group-quantity b:nth-of-type(1)").on('click', function() {
        changeQuantity(-1);
    });
    $(".form-group-quantity b:nth-of-type(2)").on('click', function() {
        changeQuantity(1);
    });

    $('.Carousel-slider').slick('slickSetOption', {
       responsive: [
          {
            breakpoint: 768,
            settings: {
